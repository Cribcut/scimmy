        ...
        // If name was omitted, assume config is for top-level assignment
            ...
            for (let [key, value] of Object.entries(config)) {
                ...
                if (key === "documentationUri") {
                    ...
                    if (!!value) Config.#config.documentationUri = lib_schemas.Schemas.ServiceProviderConfig.definition.attribute(key).coerce(value);
                    ...
                    else target.push(...lib_schemas.Schemas.ServiceProviderConfig.definition.attribute(key).coerce(Array.isArray(value) ? value : [value]));
                } else {
                    ...
                    // No shorthand, make sure value is an object
                        ...
                        try {
                            ...
                            Object.assign(target, lib_schemas.Schemas.ServiceProviderConfig.definition.attribute(key)
